...
import com.example.cornerfinder.recommended.RecyclerViewHolder;

import java.util.List;

// Adaptador para el RecyclerView que muestra los elementos recomendados
public class SavedPlacesAdapter extends RecyclerView.Adapter<RecyclerViewHolder>{
    // Lista de elementos recomendados y fragmento que contiene el RecyclerView
    private List<RecyclerItems> dataset;
    private Fragment fragment;

    // Constructor del adaptador
    public SavedPlacesAdapter(List<RecyclerItems> dataSet, Fragment fragment){
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        View recommendView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_cell_saved, parent, false);
