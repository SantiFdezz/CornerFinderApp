...
public class SummerModeData {
    ...
    public SummerModeData(String placeName, String descripcion, String location, String etiqueta,String image_url){
    ...
    public SummerModeData(JSONObject json){
        try{
